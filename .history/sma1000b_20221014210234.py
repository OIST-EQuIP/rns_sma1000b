...
class SMA1000B:
    ...
    def set_power_sweep_list(self, pow_list, dwell_list=0.001, repeat=False):
        ...
        self.instrument.write(f"SOUR1:LIST:FREQ:MODE LIST")
    ...
    def reset_power_sweep(self):
        self.instrument.write(f"SOUR1:LIST:MODE MANUAL")
