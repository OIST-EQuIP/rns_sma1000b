...
class SMA1000B:
    ...
    def set_power_range_sweep(self, start, stop, dwell=0.001, repeat=False):
        ...
        self.instrument.write(f"SOUR1:SWE:POW:DWELI {dwell}")
    ...
    def start_list_sweep(self):
        ...
        # TODO
        # if already middle of running, set index to whatever and continue
        cur_ind = self.instrument.query("SOUR1:LIST:IND?")
        max_ind = 
        print(cur_ind)
        self.instrument.write(f"SOUR1:LIST:IND {self.pause_idx}")
    ...
    def stop_sweep(self):
        ...
        self.pause_idx = self.instrument.query("SOUR1:LIST:IND?")
        self.instrument.write(f"SOUR1:FREQ:MODE CW")
        # stopping the power range sweep
