...
class SMB1000:
    ...
    def set_power_sweep(self, start, stop, state, mode):
        ...
        # self.instrument.write(f"SOUR1:POW:MODE SWE")
        self.instrument.write(f":TRIG1:PSW:SOUR1 SING")
        self.instrument.write(f"SOUR1:SWE:POW:MODE {mode}")
    ...
    def toggle_state(self):
        self.set_state(int(~bool(self.state)))
